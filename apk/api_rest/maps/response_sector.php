...
require "conexion.php";
    ...
    function getEstaciones($user_id, $user_is_admin2,$sector) {
      ...
      global $conn;
            ...
            $sql = "
                    ...
                    WHERE
                            eq.habilitado = 1 AND se.id_sector ='".$sector."'
           ...
           // return;
            ...
            for($i=0; $i<$total; $i++){
               ...
               //$dt = new DateTime($date, new DateTimeZone('+1'));
               /**********/
